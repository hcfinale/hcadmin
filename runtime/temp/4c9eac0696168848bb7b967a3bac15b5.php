<?php /*a:8:{s:37:"./template/default/ebook/showres.html";i:1555489594;s:43:"./template/default/common/forum_public.html";i:1545268338;s:37:"./template/default/common/header.html";i:1545268308;s:24:"template/fullscreen.html";i:1545200232;s:42:"./template/default/common/topbar_user.html";i:1555491934;s:37:"./template/default/common/topbar.html";i:1555491919;s:41:"./template/default/common/right_tool.html";i:1553237427;s:37:"./template/default/common/footer.html";i:1545980648;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="mdui-col-xs-12 mdui-col-sm-9 mdui-shadow-1">
    ...
    <ul class="menu">
        <li>类别：</li>
        <li>
            <a href="<?php echo url('ebook/showres'); ?>">全部</a>
        </li>
    ...
    <div id="tool-all">
        <ul class="mdui-list part-list">
            <?php if(is_array($toolRes) || $toolRes instanceof \think\Collection || $toolRes instanceof \think\Paginator): $i = 0; $__LIST__ = $toolRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;if($res['pid'] == '1'): ?>
            <div class="mdui-col-xs-3" style="min-height: 13rem;">
                <div class="mdui-card">
                    ...
                    <div class="mdui-card-actions">
                        <a class="mdui-btn mdui-ripple" href="<?php echo url('index/ebook/downloadIt',array('id'=>$res['id'])); ?>">下载</a>
                    </div>
                </div>
            </div>
            <?php endif; ?>
    ...
    <div id="resource-all">
        <ul class="mdui-list part-list">
            <?php if(is_array($toolRes) || $toolRes instanceof \think\Collection || $toolRes instanceof \think\Paginator): $i = 0; $__LIST__ = $toolRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;if($res['pid'] == '2'): ?>
            <div class="mdui-col-xs-3" style="min-height: 13rem;">
                <div class="mdui-card">
                    <div class="mdui-card-media">
                        <img src="<?php echo htmlentities($res['img']); ?>"/>
...
$(window).on('load',function () {
    ...
    $('.menu>li>a').click(function () {
        ...
        $.post("<?php echo url('ebook/ajaxRes'); ?>",{forumName:pName,forumId:pId},function(result){
