<?php /*a:7:{s:41:"./template/default/user/index_public.html";i:1545200232;s:43:"./template/default/common/forum_public.html";i:1545268338;s:37:"./template/default/common/header.html";i:1545268308;s:24:"template/fullscreen.html";i:1545200232;s:42:"./template/default/common/topbar_user.html";i:1552445826;s:37:"./template/default/common/topbar.html";i:1552445915;s:37:"./template/default/common/footer.html";i:1545980648;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="mdui-col-xs-12 mdui-col-sm-8 mdui-col-offset-sm-2 mdui-m-y-1">
    <div class="mdui-card">
        <div class="mdui-card-media">
            <img src="/public/static/images/card.png" height="200px" />
            <div class="mlt-user-info">
              <div class="mlt-avatar-box">
                <img src="<?php echo htmlentities($userInfo['avatar']); ?>" alt="<?php echo htmlentities($userInfo['username']); ?>的头像" id="avatar_preview" />
              </div>
              <div class="mlt-user-username">
                <?php echo htmlentities($userInfo['username']); ?>
              </div>
              <div class="mlt-user-data">
                <a href><?php echo htmlentities($userInfo['topics']); ?> 主题</a>
                <span class="mdui-m-x-1">|</span>
                <a href><?php echo htmlentities($userInfo['comments']); ?> 回复</a>
                <span class="mdui-m-x-1">|</span>
                <a href><?php echo htmlentities((isset($userInfo['motto']) && ($userInfo['motto'] !== '')?$userInfo['motto']:"这家伙很懒，什么也没留下")); ?></a>
              </div>
            </div>
        </div>
        ...
        <div class="mdui-card-content">
            ...
            <div id="info">
                <div class="mdui-col-xs-12">
                    <h5>活跃情况</h5>
                    <ul>
                        <li>用户组：<?php echo htmlentities($userInfo['groupData']['groupName']); ?></li>
                        <li>注册时间：<?php echo htmlentities(date('Y-m-d H:i',!is_numeric($userInfo['create_date'])? strtotime($userInfo['create_date']) : $userInfo['create_date'])); ?></li>
                        <li>最后访问：<?php echo htmlentities(date('Y-m-d H:i',!is_numeric($userInfo['login_date'])? strtotime($userInfo['login_date']) : $userInfo['login_date'])); ?></li>
                        <li>主题数：<?php echo htmlentities($userInfo['topics']); ?></li>
                        <li>回帖数：<?php echo htmlentities($userInfo['comments']); ?></li>
                    </ul>
                </div>
